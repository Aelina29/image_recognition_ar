...
public class AugmentedImageActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Button rotationSeekBar = findViewById(R.id.button1);
    ...
    private void drawAugmentedImages(
        ...
        for (Pair<AugmentedImage, Anchor> pair : augmentedImageMap.values()) {
            ...
            switch (augmentedImage.getTrackingState()) {
                case TRACKING:
                    Log.i("kpop", String.valueOf(rotationOn));
                    augmentedImageRenderer.draw(
                            viewmtx, projmtx, augmentedImage, centerAnchor, colorCorrectionRgba, rotationOn);
                    break;
                default:
                    break;
            }
    ...
    private Bitmap loadAugmentedImageBitmap() {
        try (InputStream is = getAssets().open("default.jpg")) {
            Log.i(TAG, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAugmented image bitmap loaded");
