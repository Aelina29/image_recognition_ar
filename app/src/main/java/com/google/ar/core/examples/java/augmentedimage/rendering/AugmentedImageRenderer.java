...
public class AugmentedImageRenderer {
    ...
    private final ObjectRenderer ufoObject = new ObjectRenderer();
    ...
    public void createOnGlThread(Context context) throws IOException {
        ...
        ufoObject.createOnGlThread(
                context, "models/model.obj", "models/red.jpg");
        ufoObject.setMaterialProperties(0.0f, 3.5f, 1.0f, 6.0f);
        ufoObject.setBlendMode(BlendMode.AlphaBlending);
    }
private float rotateProgress =0;
    public void draw(
        ...
        if(rotationOn)
            rotateProgress +=2.5;
        anchorPose.compose(Pose.makeTranslation(
                0.0f * augmentedImage.getExtentX(),
                0.0f,
                0.0f * augmentedImage.getExtentZ())).toMatrix(modelMatrix, 0);
        ufoObject.updateModelMatrix(modelMatrix, 1.0f, rotateProgress);
        ufoObject.draw(viewMatrix, projectionMatrix, colorCorrectionRgba, tintColor);
    }
